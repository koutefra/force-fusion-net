...
class Visualizer:
    ...
    def draw_frame(
        ...
        if self.output_dir:
            pygame.image.save(screen, os.path.join(self.output_dir, f"frame_{frame_number}.png"))
    ...
    def _create_gif(self, scene_id: str, duration: float = 0.1) -> None:
        ...
        gif_filename = f"scene_{scene_id}_animation.gif"

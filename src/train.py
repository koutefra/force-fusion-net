...
parser.add_argument("--epochs", required=True, type=int, default=4, help="Number of training epochs.")
...
parser.add_argument("--dropout", required=True, type=float, default=0.0, help="Dropout rate for the model.")
...
parser.add_argument("--train_scenes", type=lambda x: x.strip('[]').split(','), 
                    default=['b090', 'b100', 'b110', 'b120', 'b140', 'b160', 'b180', 'b200', 'b220', 'l0', 'l2', 'l4'],
                    help="Training scenes as a comma-separated list (e.g., b090,b100).")
parser.add_argument("--val_scenes", type=lambda x: x.strip('[]').split(','), default=["b250"],
                    help="Validation scenes as a comma-separated list (e.g., b250).")
